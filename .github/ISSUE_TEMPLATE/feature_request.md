...
about: Propose a Java-port-only API addition or ergonomics improvement
title: "feat: "
labels: enhancement
---
...
JAVA-PORT-ONLY changes (better ergonomics, new convenience overloads,
performance improvements that don't affect the wire output).
-->
